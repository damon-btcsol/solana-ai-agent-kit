from construct import (
    BitsInteger, BitsSwapped, BitStruct, Bytes, BytesInteger, Const, Flag, 
    Int8ul, Int32ul, Int64ul, Padding, Struct as cStruct
)

# Layout for Liquidity State V4
